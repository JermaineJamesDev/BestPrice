...
class OCRPerformanceManager {
  ...
  static Future<String?> _optimizeImageForOCR(String imagePath) async {
    try {
      ...
      final optimizedBytes = img.encodeJpg(optimized, quality: imageCompressionQuality);
      
      // Save optimized version
      final optimizedPath = '${file.parent.path}/optimized_${DateTime.now().millisecondsSinceEpoch}.jpg';
